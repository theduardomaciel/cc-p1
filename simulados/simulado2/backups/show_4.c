...
int maior_valor(double num1, double num2, double num3) {
...
int main() {
    ...
    if (integrantes_permitidos_casa1 > 0 || integrantes_permitidos_casa2 > 0 || integrantes_permitidos_casa3 > 0) {
        ...
        if (valor_casa1 >= valor_casa2 && valor_casa1 >= valor_casa3) {
            ...
            // obs 1:
            if (valor_casa1 == valor_casa2 || valor_casa1 == valor_casa3) {
                if (integrantes_permitidos_casa1 > integrantes_permitidos_casa2 && integrantes_permitidos_casa1 > integrantes_permitidos_casa2) {
                    print_resultado(1, valor_casa1, integrantes_permitidos_casa1);
                } else if (integrantes_permitidos_casa2 > integrantes_permitidos_casa3) {
            ...
            // obs 1:
            if (valor_casa2 == valor_casa1 || valor_casa2 == valor_casa3) {
                if (integrantes_permitidos_casa1 > integrantes_permitidos_casa2 && integrantes_permitidos_casa1 > integrantes_permitidos_casa2) {
                    print_resultado(1, valor_casa1, integrantes_permitidos_casa1);
                } else if (integrantes_permitidos_casa2 > integrantes_permitidos_casa3) {
                    print_resultado(2, valor_casa2, integrantes_permitidos_casa2);
